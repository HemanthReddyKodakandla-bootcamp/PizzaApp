                ...
                currentAccountPicture: new CircleAvatar(
                  backgroundColor:
                      Theme.of(context).platform == TargetPlatform.iOS
                          ...
                          : Colors.white,
                  child: new Text(
                    widget.userdata["user_name"].substring(0, 1),
                    style: TextStyle(
                    ...
                    Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (BuildContext context) =>
                              new Favorites(userdata: widget.userdata)),
                    );
                  }),
              new ListTile(
                  title: Text(
                    ...
                    children: <Widget>[
                      Expanded(
                        child: new Image.network(
                            'https://www.pizzahut.com.pk/p_h_logo.png',
                            height: 200,
                            width: 350,
                            alignment: Alignment.center),
                      ),
              ...
              child: new Card(
                ...
                child: new Row(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: new Image.network(
                          'http://www.jsdirectory.com/wp-content/uploads/2018/09/pizza-hut-2-medium-pizzas.jpg',
                          height: 200,
                          width: 350,
                          alignment: Alignment.center),
                    ),
...
//        return Location(userdata: widget.userdata, location: widget.location, type: widget.type);
      return Container(
        child: new Card(
          child: ListView(
            children: <Widget>[
      ...
      // return Mode(userdata: widget.userdata, location: widget.location, type: widget.type);
