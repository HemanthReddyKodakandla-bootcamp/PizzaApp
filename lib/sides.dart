...
class _SidesState extends State<Sides> {
  String url = "https://pizzahuttest.herokuapp.com/api/sides";
  ...
  loadDrop() {
    values.add(new DropdownMenuItem(
      child: new Text('Tomato sauce'),
      value: 'Tomato sauce',
    ));
    values.add(new DropdownMenuItem(
      child: new Text('Chilli sauce'),
      value: 'Chilli sauce',
    ));
    values.add(new DropdownMenuItem(
      child: new Text('Bechamel sauce'),
                  ...
                  new Row(
                    ...
                    children: <Widget>[
                      new DropdownButton<String>(
                        items: values,
                        value: size_selected,iconSize: 15,
                        hint: Text('Sauce'),
